...
/* Modified to allow capture of MJPEG frames.
 * This should probably be rewritten at some point with MJPEG frames as the primary focus
 * instead of hacked together from raw frame code.
 * */
...
bool Webcam::read_frame()
{
    ...
    memcpy(rgb_frame.data, buffers[buf.index].data, buf.bytesused);
    rgb_frame.size = buf.bytesused;
